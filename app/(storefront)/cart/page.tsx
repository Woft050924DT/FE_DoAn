  ...
  if (loading) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-16 flex items-center justify-center">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#1565C0]" />
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      <div className="flex items-center gap-3 mb-6">
        <button onClick={() => router.push("/products")} className="p-2 hover:bg-gray-100 rounded-lg">
            ...
            <div key={item.id} className="bg-white rounded-xl border border-[#E0E0E0] p-4">
              <div className="flex gap-3">
                ...
                <img
                  ...
                  onClick={() => router.push(`/products/${item.product.product_id}`)}
                />
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-3 flex-wrap gap-2">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button onClick={() => removeItem(item.id)} className="p-1.5 text-[#757575] hover:text-[#E53935] hover:bg-red-50 rounded-lg transition-colors">
                        <Trash2 size={15} />
                      </button>
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-xl border border-[#E0E0E0] p-4">
            ...
            {couponApplied ? (
              <div className="flex items-center gap-2 bg-green-50 border border-green-200 rounded-lg px-3 py-2">
                ...
                <button onClick={() => { setCouponApplied(false); setCouponCode(""); }} className="ml-auto text-xs text-[#757575] hover:text-[#E53935]">Xóa</button>
              </div>
            ) : (
              <div className="flex gap-2">
                <input
                  ...
                  className={`flex-1 border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#1565C0] ${couponError ? "border-[#E53935]" : "border-[#E0E0E0]"}`}
                />
                <button onClick={applyCoupon} className="bg-[#E53935] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#C62828] transition-colors">Áp dụng</button>
              </div>
            )}
