...
import {
  TrendingUp, TrendingDown, ShoppingBag, Users, MessageSquare, DollarSign
} from "lucide-react";
import {
...
const REVENUE_DATA = [
  ...
  { day: "T5", revenue: 68000000 },
  { day: "T6", revenue: 75000000 },
  { day: "T7", revenue: 92000000 },
        ...
        <div className="xl:col-span-2 bg-white rounded-2xl border border-[#E0E0E0] p-5">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <LineChart data={REVENUE_DATA}>
              ...
              <YAxis tickFormatter={formatRevenueLabel} tick={{ fontSize: 11, fill: "#757575" }} axisLine={false} tickLine={false} />
              <Tooltip
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
        ...
        <div className="bg-white rounded-2xl border border-[#E0E0E0] overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-[#E0E0E0]">
            ...
            <button onClick={() => navigate("/admin/chat")} className="text-sm text-[#1565C0] hover:underline">
              Xem tất cả
            </button>
          </div>
            ...
            {CHAT_CONVERSATIONS.map((conv) => (
              <div key={conv.id} className="px-4 py-3 hover:bg-[#F5F6FA] cursor-pointer">
                <div className="flex items-start gap-2.5">
                  <div className="w-8 h-8 bg-[#E53935] rounded-full flex items-center justify-center text-white text-xs font-bold shrink-0">
